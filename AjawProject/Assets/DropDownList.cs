    ...
    public class DropDownList : MonoBehaviour
    {
		...
		*/
        ...
        private void UpdateSelected()
        {
            ...
            {
                // @ch removed! It would make that, once selected an option, it will remain with the highlighted color always; and the other ones won't be highlighted when the cursor is on them.
